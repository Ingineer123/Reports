...
def parse_string(*args, **kwargs):
    '''
        ...
        NOTE: CREATE WIDGETS FOR THE FILE SELECTION INPUT/OUTPUT
        NOTE: CREATE KIWY UI
    '''

    ## convert and find xlsx file --> make a widget for file location later
    ## [.....] ADD WIDGET HERE NOTE: FOR LAYER
    ...
    ## NOTE: UNCOMMENT THIS BLOCK IF U WANT TO REMOVE DATE INPUT
    ...
    except (ValueError, TypeError, AttributeError) as input_err:
        print('Отакої, щось ти не те натайпав (」°ロ°)')
        pass
    ...
    try:
        yest = get_time - datetime.timedelta(days=1)
